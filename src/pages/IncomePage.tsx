...
export function IncomePage() {
  ...
  const { isPro, isAtIncomeLimit, canExportCsv } =
    useSubscription(allLoadedIncome);
  const {
  ...
  const confirmBulkDelete = async () => {
    ...
    try {
      ...
      toast({
        title: `${selectedIds.size} entries removed`,
        status: 'info',
        duration: 2500,
        isClosable: true,
      });
      ...
      toast({
        title: 'Failed to delete some entries',
        status: 'error',
        duration: 3000,
        isClosable: true,
      });
  ...
  const [allTimeSources, setAllTimeSources] = useState<Array<{
    source: string;
    total: number;
    count: number;
  }> | null>(null);
  ...
  const hasLoggedThisMonth = allLoadedIncome.some((e) =>
    ...
    <Box>
            ...
            action={
              <HStack spacing={2}>
                <Button
                  ...
                  onClick={() =>
                    canExportCsv
                      ? exportIncomeCsv(allLoadedIncome, currency)
                      : onUpgradeOpen()
                  }
                >
                  Export CSV
                ...
                <Button
                  leftIcon={
                    <Icon as={bulkMode ? RiCloseLine : RiCheckboxLine} />
                  }
                  variant='outline'
                  borderColor={bulkMode ? '#4C5FD5' : '#E8E8E3'}
            ...
            {initialLoading ? (
              ...
              >
                ...
                <Text
                  ...
                  mx='auto'
                >
                  Add your first payment to start tracking your financial
                  timeline.
                </Text>
                <Button
                  leftIcon={<Icon as={RiAddLine} />}
                  ...
                  >
                    ...
                    >
                      <Tab
                        ...
                        px={4}
                        h='30px'
                        _selected={{ bg: '#4C5FD5', color: 'white' }}
                        color='#5a6a7a'
                      >
                        <Icon as={RiArrowDownSLine} mr={1.5} boxSize='14px' />
                        Timeline
                      </Tab>
                      <Tab
                        fontWeight='600'
                        ...
                        color='#5a6a7a'
                      >
                        <Icon as={RiPieChartLine} mr={1.5} boxSize='14px' />
                        By Source
                      </Tab>
                    </TabList>
                    ...
                    {bulkMode && selectedIds.size > 0 && (
                      ...
                      >
                        ...
                        <Button
                          ...
                          h='24px'
                          leftIcon={
                            <Icon as={RiDeleteBin2Line} boxSize='11px' />
                          }
                          _hover={{ bg: '#be123c' }}
                  ...
                  <TabPanels>
                    ...
                    <TabPanel p={0}>
                      {(() => {
                        ...
                        const entryCount = sorted.reduce(
                          (s, d) => s + d.count,
                          0,
                        );
                            ...
                            >
                              <HStack justify='space-between'>
                                <Text
                                  ...
                                  fontWeight='500'
                                >
                                  Total across all sources ({entryCount} entries
                                  {allTimeSources === null &&
                                  unloadedYears.length > 0
                                    ? ', loaded years only'
                                    : ''}
      ...
      >
        ...
        >
          ...
          <AlertDialogBody fontSize='13px' color='#5a6a7a'>
            This will permanently remove the selected income entries and update
            all your financial metrics. This cannot be undone.
          </AlertDialogBody>
      ...
      >
        ...
        >
          ...
          <AlertDialogBody fontSize='13px' color='#5a6a7a'>
            This will permanently remove this income entry and update all your
            financial metrics.
          </AlertDialogBody>
          <AlertDialogFooter gap={2}>
            <Button
