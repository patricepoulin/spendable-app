...
const theme = extendTheme({
  ...
  colors: {
    brand: { 50:'#eef0fb',100:'#d5d9f5',200:'#adb4ec',300:'#8590e2',400:'#6270d9',500:'#4C5FD5',600:'#3D4FBF',700:'#2e3d99',800:'#222e72',900:'#16204c' },
    navy:  { 700:'#253344',800:'#1C2B3A',900:'#141f2b' },
    ynabGreen: { 50:'#eafaf1',100:'#d5f5e3',500:'#27AE60',600:'#219653',700:'#1a7a43' },
    ynabAmber: { 50:'#fefae8',100:'#fdf3c0',500:'#F2C94C',600:'#d4a800' },
    ynabRed:   { 50:'#fef2f2',100:'#fde0e0',500:'#EB5757',600:'#c93c3c' },
  },
  semanticTokens: {
    colors: {
    ...
    Button: {
      ...
      variants: {
        solid: (props: { colorScheme: string }) => ({
          ...(props.colorScheme === 'brand' ? { bg:'#4C5FD5', color:'white', _hover:{bg:'#3D4FBF'}, _active:{bg:'#2e3d99'} } : {}),
        }),
      },
    },
    Input:  { defaultProps: { focusBorderColor: 'brand.500' }, baseStyle: { field: { borderRadius: '8px' } } },
  ...
  if (!user) {
    return (
      <Routes>
        ...
        {/* Everything else — including / — goes to sign in */}
  ...
  return (
    <AppShell>
      <Routes>
        ...
        <Route path="/terms"    element={<TermsPage />} />
        <Route path="/privacy"  element={<PrivacyPage />} />
        {/* /auth while logged in → dashboard */}
        <Route path="/auth"     element={<Navigate to="/" replace />} />
        {/* Truly unknown routes → branded 404 */}
